...
const accessibleCSS = new hatemile.implementation.AccessibleCSSImplementation(
    htmlParser
)
...
const accessibleEvent = new hatemile.implementation.AccessibleEventImplementation(
    htmlParser
)
